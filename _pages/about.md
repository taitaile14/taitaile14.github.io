...
I am a final-year undergraduate in **Materials Science and Engineering** at **Guangxi University**, where I work on lithium-metal battery interfaces with Prof. Meinan Liu. In parallel I do computational research with a group at **Northeastern University (Qinhuangdao)** on measurement and evaluation for machine-learning systems.

Across five projects in four fields I have held the same role: **I build the part that decides whether a claim is true.** That has meant a two-channel audit of memory and attribution in conversational agents, the evaluation harness for an identifiability result in coherent imaging, the experimental verification of a minimax bound on estimating a selected system's accuracy from a fixed label budget, and, in the lab, an interface claim that had to survive three independent cell configurations before I would report it.

My interests are **evaluation and auditing of LLM systems**, **memory, attribution, and trustworthy human–AI interaction**, **inverse problems and sample complexity**, and **AI for experimental science**. I am applying for **PhD positions starting Fall 2027**.
...
- *2026.06*: &nbsp;📄 *Two-Scan Recovery of Sparse Defects in Ptychography* is under review at *IEEE Signal Processing Letters*.
...
- *2025.09*: &nbsp;📄 Our siloxane-additive electrolyte paper appeared in *Journal of Physics: Conference Series* (CEAMS 2025).
...
<sub>Co-author lists for papers under double-blind review are withheld until notification, following the anonymity policy of each venue.</sub>
...
- **Attribution boundaries in conversational AI memory.** **First author.** Under double-blind review at a top-tier HCI venue; title and co-authors withheld until notification.
- **The accuracy–evaluation trade-off in test-time selection.** **Second author.** Under double-blind review at a top-tier machine-learning venue; title and co-authors withheld until notification.
...
- Main finding: supervised fine-tuning that improved conversational attribution did not consistently improve profile writing, and conversation-targeted fine-tuning raised observed write corruption. Reply-level evaluation alone would have scored both interventions as successes. Full numbers after notification.

**The price of test-time selection** · *2026* · second author, under double-blind review
...
- I designed and ran the entire experimental verification on frozen reasoning banks (GSM8K, MATH, CodeContests, MiniF2F), including cross-fitted frontier policies and fully optimized order-statistic and quadratic baselines at matched audit budgets.

**Sample complexity of sparse recovery in coherent imaging** · *2026* · second author, IEEE SPL under review
...
- Three cell configurations were used as three independent measurement channels — half cell, symmetric cell, full cell — and a claim that survived in only one channel was not reported as a general improvement. Nucleation overpotential fell from **145 to 114 mV**, symmetric cells stayed near **30 mV for 330 h**, and full cells kept **85.3% after 600 cycles** at 0.5 C.
- I localized failure on **both sides** of the optimum instead of reporting only the best setting: too little treatment leaves uncovered nucleation sites and collapses at cycle 45; too much builds a layer that cracks and collapses at cycle 30. EIS and XRD identified the mechanism separately, so the performance claim rests on an identified cause and not a correlation. The whole route uses commercial reagents and standard CR2025 hardware, so other labs can repeat it.
...
- Closest to my own work: at **Nanning Industrial Investment Aluminium-Based New Materials Group** I followed the full ingot-to-foil chain for 12 μm lithium-battery cathode current-collector foil — the component I hand-assemble into coin cells, made there by the hundred-thousand tonne. Standing at the inspection points where industrial process data is actually produced shapes how I think about deployed models: on a plant floor a system is judged by throughput, yield, and inspectability, not by one headline number.

<span class='anchor' id='education'></span>

# 📖 Education

- *2022–2026 (expected Jun.)*, **Guangxi University**, B.Eng. in Materials Science and Engineering, School of Resources, Environment and Materials.
...
<sub>Both public CVs are the double-blind-safe versions: titles and venues of papers under review are masked. Unmasked copies are sent directly to programs on request.</sub>
